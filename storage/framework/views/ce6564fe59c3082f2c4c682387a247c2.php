      ...
      <div class="flex-col">
        ...
        <div class="card">
          ...
          <table>
            ...
            <tbody>
                  <?php $__currentLoopData = $latestRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
...
<?php /**PATH C:\xampp\htdocs\AssembleP2\resources\views\dashboard.blade.php ENDPATH**/ ?>