                    ...
                    <tbody id="patientTable">
                          @foreach ($healthRecords as $record)
                            <tr>
                              ...
                              <td>
                                <button class="action-btn view" onclick="openViewModalFromData(this)" data-record='@json($record)'>View</button>
                                <button class="edit-btn" onclick="openEditModalFromData(this)" data-record='@json($record)'>Edit</button>
                                <button class="delete-btn" onclick="openDeletePatientModal('{{ $record->id }}', '{{ $record->first_name }}', '{{ $record->last_name }}')">Delete</button>
        ...
        <div id="editConfirmModal" class="modal">
          ...
          <div class="pagination-wrapper">
            <div class="pagination">
                ...
                @else
                    <a href="{{ $healthRecords->previousPageUrl() }}" class="pagination-button">Previous</a>
                @endif

                <span class="pagination-page current">{{ $healthRecords->currentPage() }}</span>

                @if ($healthRecords->hasMorePages())
                    <a href="{{ $healthRecords->nextPageUrl() }}" class="pagination-button">Next</a>
                @else
